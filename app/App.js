...
import { View, Text, StyleSheet, StatusBar, Animated, ImageBackground } from 'react-native';
      ...
      <>
        ...
        <ImageBackground source={require('./assets/img/background.jpg')} style={styles.img}>
          <View>
            ...
            <Animated.Image style={[styles.image_cloud1, {left: position}]} source={Cloud1}/>
            <Animated.Image style={[styles.image_cloud2, {right: position}]} source={Cloud2}/>
          </View>         
          <Animated.Text style={[styles.text, {opacity: show, transform:[{scale: font}]}]}>Climapp</Animated.Text>
          </ImageBackground> 
        </View>
